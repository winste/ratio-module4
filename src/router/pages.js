...
class Pages {
  ...
  constructor() {
    ...
    this.container.append(
      // в самом начале добавляем хэдэр, не дожидаясь рендера всей страницы
      this.#header.render(),
  ...
  render(pageName) {
    switch (pageName) {
      case 'home':
        ...
        break
      case 'blog':
        this.renderPage(this.#banner.render(), this.#blog.render(true))
        break
      case 'about':
        this.renderPage(this.#about.render())
        break
      case 'article':
        this.renderPage(this.#article.render())
        break
      case 'error':
        this.renderPage(this.#error.render())
        break
      default:
        break
    }
